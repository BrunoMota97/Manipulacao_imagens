...
void rotacao_esquerda(FILE* f1, FILE* f2){
 ...
 for (int j =image.width-1; j>=0; j--){ // imprime os pixeis
  for (int k = 0;k<image.height; k++){ //imprime de bauxi para cima, pois vai começar por imprimir a partir da primeira coluna,última linha
