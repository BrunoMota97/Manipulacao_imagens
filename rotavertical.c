...
void vertical(FILE* f1,FILE* f2){
  ...
  PPM image;
   ...
   int mid = image.height / 2; // precisamos de pensar da seguinte maneira: dividir a imagem ao meio, tendo como referencial a altura, de cima até ao meio
     PPMPIXEL a;
    for (int j = 0; j < image.width; j++){
